...
namespace pimoroni {
  ...
  bool Esp32Spi::init(uint8_t cs, uint8_t sck, uint8_t mosi, uint8_t miso, uint8_t resetn, uint8_t gpio0, uint8_t ack) {
    driver.init(cs, sck, mosi, miso, resetn, gpio0, ack);
    driver.reset();
